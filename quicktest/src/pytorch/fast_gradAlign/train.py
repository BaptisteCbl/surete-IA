...
from src.pytorch.fast_gradAlign.utils import rob_acc, l2_norm_batch, get_input_grad, clamp
...
def main():
    ...
    logger.info("Epoch,Train loss,Train acc clean,Train acc PGD, Test acc clean,Test acc FGSM,Test acc PGD,Training time,Time elapsed")
    ...
    for epoch in range(args.epochs + 1):
        ...
        if epoch == args.epochs:
            torch.save(
                ...
                "src/pytorch/saves/fast_gradAlign{} epoch={}.pth".format(model_name, epoch),
            )
