...
index = 1
base = x[index, :, :, :].swapaxes(0, 1).swapaxes(1, 2)
adv_pgd = Adv_img_pgd[index, :, :, :].swapaxes(0, 1).swapaxes(1, 2)
adv_fgm = Adv_img_fgm[index, :, :, :].swapaxes(0, 1).swapaxes(1, 2)


fig, (ax1, ax2, ax3) = plt.subplots(1, 3)
ax1.imshow(base)
ax1.set_title(y_pred[index])
ax2.imshow(adv_pgd)
ax2.set_title(y_pred_pgd[index])
ax3.imshow(adv_fgm)
ax3.set_title(y_pred_fgm[index])
